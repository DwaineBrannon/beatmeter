...
const AlbumCardContainer = styled.div`
  ...
  box-shadow: ${props =>
    props.variant === 'grid' ? '0 4px 12px rgba(0, 0, 0, 0.1)' : 'none'};
  border: none;
  border-radius: ${props =>
    props.variant === 'grid'
      ? '12px'
  ...
  transition: ${props =>
    props.variant === 'grid' ? 'transform 0.3s, box-shadow 0.3s' : 'none'};
...
const AlbumImage = styled.img`
  ...
  border-radius: ${props =>
    props.variant === 'grid' ? '0' : props.theme.borderRadius.large || '16px'};
  box-shadow: ${props =>
    props.variant === 'grid'
      ? 'none'
      : props.hovered
